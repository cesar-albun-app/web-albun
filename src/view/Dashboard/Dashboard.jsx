  ...
  <Container fluid className="p-4" style={{ backgroundColor: "#f8f9fa", height: "100vh" }}>
    <Row className="h-100">
      ...
      {(userRole === Roles.ADMIN || userRole === Roles.DUBIA) && (
        <>
          <Col md={3} className="mb-4">
            <Card className="h-50" style={{ backgroundColor: "#ffc107", color: "white" }}>
              <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                <h6>Dubia Carga</h6>
          ...
          <Col md={3} className="mb-4">
            <Card className="h-50" style={{ backgroundColor: "blue", color: "white" }}>
              <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                <h6>Dubia Web</h6>
                <Button variant="light" as={Link} to="/dubiaVentas" target="_blank" rel="noopener noreferrer">
                  Web
                </Button>
              </Card.Body>
            </Card>
...
{(userRole === Roles.ADMIN || userRole === Roles.DRS) && (
        <>
          ...
          <Col md={3} className="mb-4">
            <Card className="h-50" style={{ backgroundColor: "blue", color: "white" }}>
              <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                <h6>Web</h6>
                <Button variant="light" as={Link} to="/docKarla" target="_blank" rel="noopener noreferrer">
                  Web
                </Button>
              </Card.Body>
            </Card>
      ...
      {userRole === Roles.ADMIN && (
        <>
          ...
          <Col md={3} className="mb-4">
            <Card className="h-100" style={{ backgroundColor: "#9188c2", color: "white" }}>
              <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                <h6>Viajes</h6>
