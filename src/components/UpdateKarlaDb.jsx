...
const UpdateKarlaDb = ({ selectedImages, handleClearImages }) => {
  ...
  const handleAddItem = async (e) => {
    ...
    try {
      ...
      await addDoc(collection(db, "table-karla"), {
        productName,
        subtitle,
        details,
        amount,
          ...
          <Form onSubmit={handleAddItem}>
            ...
            <Form.Select
              ...
              >
                ...
                <option value="Poduct">Productos</option>
                <option value="Trata">Tratamientos</option>
